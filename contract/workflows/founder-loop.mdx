...
Ship a hypothesis, read the signals, close the loop. Decisions come from evidence
written back to the contract — not memory. This is the founder's core operating loop.

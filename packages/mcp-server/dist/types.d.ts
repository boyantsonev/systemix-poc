...
export type ToolHandler<TArgs = Record<string, unknown>> = (args: TArgs, projectRoot: string) => Promise<ToolResult>;
...
export type SystemixEventType = "tool_call" | "file_read" | "file_write" | "thinking" | "agent_start" | "agent_complete" | "agent_error" | "hitl_requested" | "hitl_resolved" | "sync_complete" | "deploy_complete";
